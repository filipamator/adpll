...
# ----------------------------------------
# If lpf1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.11.21.19:12:02
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpf1_rtl_core.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpf1_ast.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpf1.vhd"                                       
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpf1_tb.vhd"                                    
}
