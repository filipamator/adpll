...
# ACDS 16.1 196 win32 2017.05.04.22:50:34
# ----------------------------------------
...
# ----------------------------------------
# If LPF2 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/LPF2_rtl_core.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/LPF2_ast.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/LPF2.vhd"                                       
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/LPF2_tb.vhd"                                    
}
